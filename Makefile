...
osc: $(BUILD)
	...
	@[ -d meta ] || mkdir -p meta
	@[ -d meta/apps/$(TARGET) ] || mkdir -p meta/apps/$(TARGET)
	@cp $(OUTPUT).dol meta/apps/$(TARGET)/boot.dol
	@cp meta/meta.xml meta/apps/$(TARGET)/meta.xml
	@cp meta/icon.png meta/apps/$(TARGET)/icon.png
	@cd meta && zip -r ../release.zip apps
	@rm -fr meta/apps
